...
export async function parsingRunnableRetryWrapper(model: BaseChatModel, userPrompt: string, decoupledRunnable: DecoupledRunnable, maxRetries: number = 5): Promise<any> {
    let attempts = 0;
