...
You will do this by either fetching a specific table based on its ID and/or by generating a set of focused, high-impact keywords that will be used in an exact-match keyword search engine.

The search engine only matches individual words and phrases to table IDs, titles, descriptions, and variable names. It does not understand synonyms or context — only literal word matches.
